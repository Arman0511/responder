...
import '../ui/dialogs/admin_login/admin_login_dialog.dart';
...
void setupDialogUi() {
  ...
  final Map<DialogType, DialogBuilder> builders = {
    ...
    DialogType.adminLogin: (context, request, completer) =>
        AdminLoginDialog(request: request, completer: completer),
  };
